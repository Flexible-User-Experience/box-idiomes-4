...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, NotificationService $ns): Response
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, NotificationService $ns): RedirectResponse
    {
